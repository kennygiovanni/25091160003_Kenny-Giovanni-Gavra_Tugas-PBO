...
public class Main {
    ...
    public static void main(String [] args) {
        gym.tambahMember(new Member("M001", "Budi Santoso", "08123720837", "Bulanan", "Aktif"));
        gym.tambahMember(new Member("M002", "Siti Aminah", "08134820399", "Tahunan", "Aktif"));

        gym.tambahAlat(new CardioEquipment("A001", "Treadmill", "Technogym", "Baik", 20, 60));
        gym.tambahAlat(new WeightEquipment("A002", "Dumbbell Set", "Rogue", "Baik", 40, "Dumbbell"));
        ...
        do {
            ...
            switch (pilihan) {
                case 1: {
                    ...
                    System.out.print("Jenis Membership: "); String jenis = sc.nextLine();
...
static void menuAlat() {
    ...
    do {
        ...
        System.out.println("3. Lihat Semua Alat");
        System.out.println("3. Lihat Semua Alat");
        System.out.println("4. Update Kondisi Alat");
        System.out.println("5. Hapus Alat");
        System.out.println("0. Kembali");
        System.out.print("Pilih Menu: ");
        pilihan = Integer.parseInt(sc.nextLine());
        ...
        switch (pilihan) {
            case 1: {
                ...
                System.out.print("Kondisi: "); String kondisi = sc.nextLine();
            ...
            case 4: {
                System.out.print("ID Alat: "); String id = sc.nextLine();
                System.out.print("Kondisi Baru:: "); String kondisi = sc.nextLine();
